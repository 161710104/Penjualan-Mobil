...
<body>
    <header id="header"><!--header-->
        ...
        @include('frontend.member.partials.headertop')
        
        @include('frontend.member.partials.headermiddle')
        
        @include('frontend.member.partials.headerbottom')
    </header><!--/header-->
    
        @include('frontend.member.partials.slider')
    <br/>
    
        @include('frontend.member.partials.section')
        

        @include('frontend.member.partials.footer')
